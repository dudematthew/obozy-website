    ...
    <div class="nav-wrapper container">
      ...
      <ul class="right hide-on-med-and-down">
        <li><a href="https://patronite.pl/obozy" target="_blank"><span class="valign-wrapper black-text"><i
                class="grey-text material-icons">local_fire_department</i>&nbsp; Zostań naszym Patronem</span></a></li>
      </ul>

      <ul class="right hide-on-med-and-down">
        <li><a href="https://www.instagram.com/obozy_gra_terenowa" target="_blank"><span
              class="valign-wrapper black-text"><i class="grey-text material-icons">center_focus_strong</i>&nbsp; Nasz
              Instagram</span></a></li>
      </ul>

      <ul class="right hide-on-med-and-down">
        <li><a href="https://www.facebook.com/ObozyGraTerenowa" target="_blank"><span
              class="valign-wrapper black-text"><i class="grey-text material-icons">public</i>&nbsp; Nasz
              Facebook</span></a></li>
      </ul>
